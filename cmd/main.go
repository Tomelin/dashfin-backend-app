...
func main() {
	...
	financialSvc, _ := service_dashboard.NewFinancialService(financialRepo, cacheClient, svcExpenseRecord, svcBankAccount, svcCreditCard, svcIncomeRecord, svcSpendingRecord)
